...
with sync_playwright() as p:
    ...
    click('设置与备份')
    expect(page.get_by_role('button',name='AI 配置',exact=True)).to_have_attribute('aria-current','page')
    ...
    page.set_viewport_size({'width':390,'height':844});click('返回')
    ...
    browser.close();print('PASS: three settings pages and independent recognition, album/camera routing, cancel/reselect/size/read-error, draft persistence, responsive layout')
